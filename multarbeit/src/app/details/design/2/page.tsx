    ...
    const instructionSteps = [
        ...
        },
        {
            ...
            content: (
                <>
                    <p className="mb-4">
                        Denken Sie daran: Ihre Entscheidung kann auf Basis einer Kombination aus Ihrer Einschätzung und der automatisierten Hilfe getroffen werden.
                    </p>
                    <p className="mb-4">
                        Die Z-Anzeige hilft Ihnen dabei einzuschätzen, wie stark die kombinierte Evidenz in Richtung „Orange“ oder „Blau“ spricht.
                    </p>
                </>
            ),
        },
        {
            ...
            content: (
                <>
                    <p className="mb-4">
                        Nach jedem Block (zB. 10 Bilder): Rückmeldung zu eigener Leistung und zur Teamleistung
                    </p>
                    <p className="mb-2">
                        <strong>Beispiele: </strong>
                    </p>
                    <p className="mb-4">
                        „In den letzten 10 Bildern lag Ihre eigene Entscheidung in 70% der Fälle richtig.“
                        „Wenn Sie den Z-Wert berücksichtigt haben, wäre die korrekte Entscheidung in 86% der Fälle getroffen worden.“
                    </p>
                    <p className="mb-4">
                        Optional: ein Hinweis, ob die automatische Hilfe in den letzten Bildern häufiger richtig lag als der Teilnehmende.
                    </p>
                    <p className="mb-2">
                        <strong>Aufmerksamkeitsintervention:</strong>
                    </p>
                    <p className="mb-4">
                        Kurze Reminder: „Achten Sie auf die Gewichtung, nicht alle Hinweise sind gleich zuverlässig.“
                    </p>
                </>
            ),
        },
    ...
    const decisionHelpSteps = [
        {
            ...
            content: (
                <>
                    ...
                    <p className="mb-4">
                        Wie können wir die Einschätzung des KI-System auf der Z-Skala realistisch variieren lassen?
                    </p>
                    <p className="mb-6">
                        Was machen wir wenn die Antworten sehr mittig (unsicher) sind?
                    </p>
                </>
            ),
        },
        ...
        },
        {
            ...
            content: (
                <>
                    <p className="mb-4">
                        Wie setzt sich die Auswertung zusammen? - Kurze Information zum mathematischen Prinzip, auf Wunsch ausklappbar.
                    </p>
                    <p className="mb-4">
                        <strong>Potentielle Information:</strong> Anhand Ihrer Sensitivität (Genauigkeit) wurde Ihre Einschätzung mit einem Gewicht von 0.4, die der Hilfe mit 0.6 berücksichtigt. Beide Evidenzwerte wurden auf einer Z-Skala kombiniert.
                    </p>
                </>
            ),
        },
                    ...
                    <div className="w-full max-w-2xl m-8 bg-white shadow-lg rounded-xl p-8 text-gray-800">
                        ...
                        <div className="flex justify-between mt-6">
                            <button
                                ...
                                className={`px-4 py-2 rounded-lg font-semibold transition ${isFirstStep
            ...
            <section className="sectionBorder">
                ...
                <div className="flex lg:flex-row gap-6 mt-6">
                    ...
                    <div className="flex-1 p-6 rounded-xl shadow-md bgLightGreen ">
                        ...
                        <ul className="list-disc list-inside space-y-1">
                            <li><code>Senden</code>-Button bei Slider-Entscheidung</li>
                            <li>Kein <code>Senden</code>-Button bei Button-Auswahl (Orange/Blau)</li>
                        </ul>
                    </div>
                    ...
                    <div className="flex-1 bgLightGreen p-6 rounded-xl shadow-md">
                        ...
                        <ul className="list-disc list-inside space-y-1">
                            ...
                            <li>Trial-Nummer</li>
                            <li><code>showInfo</code> (Info/Hilfe sichtbar)</li>
                            <li><code>showFeedback</code> (sichtbar alle 10 Trials)</li>
                        </ul>
                ...
                <div>
                    ...
                    <ul className="ml-6 list-disc list-inside mt-2 space-y-1">
                        <li><strong>Ideen:</strong> Nach jedem Trial, <strong>nach jedem Block</strong>, nur am Ende</li>
                        <li><strong>Vorteil:</strong> verhindert, dass Teilnehmende sich zu stark am Feedback orientieren</li>
                        <li><strong>Vorteil:</strong> erhält realistischeres Entscheidungsverhalten</li>
                        <li><strong>Nachteil:</strong> späteres Feedback kann Unsicherheit auslösen</li>
                    </ul>
                </div>
                    ...
                    <div className="w-full max-w-2xl m-8 bg-white shadow-lg rounded-xl p-8 text-gray-800">
                        ...
                        <div className="flex justify-between mt-6">
                            <button
                                ...
                                className={`px-4 py-2 rounded-lg font-semibold transition ${isFirstStepD
                                    ? 'bg-gray-300 text-white cursor-not-allowed'
                                    : 'bg-gray-200 text-white hover:bg-gray-300'
                                    }`}
                            >
                            ...
                            <button
                                onClick={() => setStepD((s) => Math.min(decisionHelpSteps.length - 1, s + 1))}
                                className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-lg transition"
                            >
