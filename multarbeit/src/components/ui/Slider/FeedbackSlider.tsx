...
const FeedbackSlider: React.FC<FeedbackSliderProps> = ({
  title,
  value,
  leftLabel = 'Starke Ablehnung',
  rightLabel = 'Starke Zustimmung',
  skipped = false,
}) => {
  return (
    <div className="bg-white p-4 rounded-lg shadow border">
      ...
      <div className="relative">
        <div className="h-2 bg-gray-200 rounded-full">
          <div
            className="h-2 munsellColourBG rounded-full"
        ...
        >
          <div className="w-6 h-6 rounded-full munsellColourBG text-white text-xs flex items-center justify-center shadow">
            {value.toFixed(1)}
          </div>
        </div>
      </div>
